...
The projection-white DAM bridge is deliberately denser than a campaign section: its headline anchors the left column while the explanation, comparison, and brief-to-review diagram form one grouped proof block on the right. It remains split through tablet widths and stacks in semantic order only at the phone breakpoint.
