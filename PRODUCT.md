...
- Creators need the same inputs and structure without abandoning their own AI coding agent.
...
- Seeded AI coding agent assignments for AI creators.
...
- Direct AI coding agent sync is represented by plugin login, assignments, and file returns, not live filesystem agents yet.
...
- Category bridge: “A DAM for the work your AI coding agents are still making.”
...
- Avoid engineer-only terms in buyer-facing copy. Do not lead with AI coding agents, SHA, repositories, commits, packets, or provenance when talking to agency buyers.

## Product Principles

1. The lead owns the packet.
2. Creators start from the AI coding agent plugin.
